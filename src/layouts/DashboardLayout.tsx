...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/equipment", label: "Equipment", icon: Boxes, count: "0" },
      ...
      <aside className="sidebar">
                ...
                return (
                  ...
                  >
                    ...
                    {item.to === "/equipment" ? (
                      <em
                        className={
                          item.to === "/equipment" ? "nav-count-danger" : ""
                        }
                      >
                        {maintenanceCount}
                      </em>
        ...
        <div className="sidebar-bottom">
          <div className="user-card">
            ...
            <div>
              <strong>Chantier360 Admin</strong>
      ...
      <main className="main-content">
        <header className="top-bar">
          ...
          <div className="top-actions">
            ...
            <button className="avatar-button" title="Account" type="button">
              C
            </button>
          </div>
        </header>
